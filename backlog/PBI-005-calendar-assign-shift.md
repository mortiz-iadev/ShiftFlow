...
| Estado | Spec Draft (pendiente Approved humano) |
...
- Gate 0: falta aprobación humana de SPEC-DOM-005/006, SPEC-APP-003, SPEC-ACC-002.
- Tras Approved: Architecture (si hace falta refinamiento) → Domain+Application → Frontend → Testing+Review.
